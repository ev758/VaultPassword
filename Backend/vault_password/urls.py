...
urlpatterns = [
    ...
    path('api/verified-authentication/', views.VerifiedAuthentication.as_view()),
    ...
    path('api/password-storage/update/<int:pk>/', views.ModalPasswordStorage.as_view()),
    path('api/password-storage/delete/<int:pk>/', views.ModalPasswordStorage.as_view()),
    path('api/password-storage/copy-password/<int:pk>/', views.GetPassword.as_view()),
    ...
    path('api/qrcode/delete/', views.QRCode.as_view()),
    path('api/two-factor-authentication/verification/', views.TwoFactorVerification.as_view()),
    path('api/profile/update/', views.Profile.as_view()),
